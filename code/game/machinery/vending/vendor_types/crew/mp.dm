...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police, list(
		...
		list("M3-VL Pattern MP Ballistics Vest", 0, /obj/item/clothing/suit/storage/marine/MP/vest, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_MANDATORY),
...
GLOBAL_LIST_INIT(cm_vending_clothing_military_police_warden, list(
		...
		list("STANDARD EQUIPMENT (TAKE ALL)", 0, null, null, null),
		list("Gloves", 0, /obj/item/clothing/gloves/marine, MARINE_CAN_BUY_GLOVES, VENDOR_ITEM_MANDATORY),
		list("Uniform", 0, /obj/item/clothing/under/marine/mp/warden, MARINE_CAN_BUY_UNIFORM, VENDOR_ITEM_MANDATORY),
